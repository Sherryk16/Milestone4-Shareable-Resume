...
form.addEventListener('submit', (event: Event) => {
    ...
    const education = (document.getElementById('educationt') as HTMLTextAreaElement).value;
    const experience = (document.getElementById('workExperience') as HTMLTextAreaElement).value;
    const skills = (document.getElementById('Skills') as HTMLTextAreaElement).value;

    // Save form data in localStorage with the username as the key
    const resumeData = { fname, lname, email, phone, education, experience, skills };
    ...
    const resumeHTML = `
        ...
        <p><b>Full Name:</b> <span contenteditable="true">${fname}</span></p>
        <p><b>Last Name:</b> <span contenteditable="true">${lname}</span></p>
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (username) {
        ...
        if (savedResumeData) {
            ...
            (document.getElementById('fname') as HTMLInputElement).value = resumeData.fname;
            (document.getElementById('lname') as HTMLInputElement).value = resumeData.lname;
            (document.getElementById('dob') as HTMLInputElement).value = resumeData.dob;
            (document.getElementById('email') as HTMLInputElement).value = resumeData.email;
            (document.getElementById('phone') as HTMLInputElement).value = resumeData.phone;
            (document.getElementById('educationt') as HTMLTextAreaElement).value = resumeData.education;
